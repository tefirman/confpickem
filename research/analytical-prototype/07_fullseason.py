...
WEEKS = [(2024, 2), (2024, 3), (2024, 4), (2024, 5), (2024, 6), (2024, 7),
         (2024, 8), (2024, 9), (2024, 10), (2024, 11), (2024, 12), (2024, 13),
         (2024, 14), (2024, 15), (2024, 16), (2024, 17),
         (2025, 1), (2025, 2), (2025, 3), (2025, 5), (2025, 6), (2025, 7),
         (2025, 8), (2025, 9), (2025, 10), (2025, 11), (2025, 12), (2025, 13),
         (2025, 14), (2025, 15), (2025, 16), (2025, 17)]

K_OUTCOMES = 6000
HC_ITERS = 400
HC_RESTARTS = 4
SEED = 20240
CHECKPOINT = "research/analytical-prototype/07_fullseason_results.csv"
...
def main():
    ...
    for (year, week) in WEEKS:
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            g_slate = build_sim(gdf, y, year, 150).optimize_picks(ME, confidence_range=3)
        lv_slate = g_slate  # leverage dropped (proven negative); lv_* mirrors greedy
