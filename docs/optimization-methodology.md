...
The chronological research log, including every approach that didn't pan out,
is in [`research/analytical-prototype/FINDINGS.md`](../research/analytical-prototype/FINDINGS.md).
